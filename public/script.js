  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (type === "3") {
        ...
        // Combine every combination of one flight per leg
        ...
        combinations.sort((a, b) => a.totalPrice - b.totalPrice); // Sort by cheapest first
      ...
      results.innerHTML = allResultsHTML || "<p>No itineraries found.</p>";
    } catch (err) {
